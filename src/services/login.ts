...
import { ADD_REVIEW, ADMIN_AUTH, ADMIN_CONFIRM_ORDER, 
    ADMIN_DELIVER_ORDER, ADMIN_LOGIN_ENDPOINT, ADMIN_ORDERS, 
    ADMIN_SHIP_ORDER, CAPTURE, DELETE_FROM_CART, GET_AUTH_REQ, 
    GET_CART, GET_DEFAULT_ADDRESS, GET_ORDER, GET_ORDERS, 
    GET_USERS_ENDPOINT, GOOGLE_SIGNIN, LANDING_PAGE, LOGIN_ENDPOINT, 
    LOGOUT_REQ, PAY, PLACE_ORDER, UPDATE_CART } from "../constants/routes";
