...
const NailPolish: React.FC<NailPolishProps> = ({
    ...
    return (
        ...
        className="flex flex-col items-center">
            ...
            <h1
            className="text-xs text-center desktop:pl-10 p-6 font-semibold block tablet:text-md desktop:text-lg">
                {name}
            </h1>
            <p
            className=" text-xxs text-center desktop:pl-8 tablet:text-xs desktop:text-sm">
                {description}
            </p>
        </div>
    )
