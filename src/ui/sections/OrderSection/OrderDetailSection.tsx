...
const OrderDetailSection: React.FC<OrderDetailSectionProps> = ({order, setIsManageOrderOpen, id, setId, setIsAddReviewOpen})=>{
        ...
        <div className='w-[70%] border bg-white border-secondarydark rounded m-auto'>
            ...
            <div className="mx-8 my-6 flex justify-between items-center">
                <div className="flex items-center">
                    <p className="mx-2 font-bold text-md">Order #12345</p>
                    {status === "delivered" && 
                        <p className="text-xs my-1 text-gray-500">Delivered</p>
                    } 
                    {status !== "delivered" && 
                        <p className="text-xs">Delivery</p>
                    }
                    <p className="text-xs ml-2">on March 22, 2025</p>
                </div>
                <div className="flex items-center space-x-4">
                    <button className="text-xs" onClick={() => {setId(id); setIsAddReviewOpen(true)}}>Add Review</button>
