                ...
                className="flex justify-between mb-1 tablet:mb-5">
                    ...
                    className="grid grid-cols-2 max-w-40% tablet:grid-rows-1 tablet:grid-cols-2 tablet:min-w-[80%] tablet:gap-3">
                        ...
                        <div>
                            ...
                            <ul>
                                <li>
                                    <a href="mailto:canadiangelnailsinc@gmail.com">
                                        canadiangelnailsinc@gmail.com
                                    </a>
                                </li>
                                <li>
                                    +1 (437)-757-8889
                        ...
                        className="col-span-2 tablet:col-span-1 desktop:max-w-[300px]">
                            ...
                            className="flex justify-between items-center max-w-[60%] tablet:min-w-[80%] ">
                                ...
                                className="bg-secondarylight rounded-full w-fit max-h-fit p-3">
                                    <a target="_blank" rel="noreferrer" href="https://www.pinterest.com/canadiangelnails/">
                                        {/* pinterest svg */}
                                        <svg width="18" height="18" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 511.998 511.998" fill="#D8B192">
                                ...
                                <li
                                className="bg-secondarylight rounded-full w-fit max-h-fit p-3">
                                    <a target="_blank" rel="noreferrer" href="https://www.instagram.com/canadiangelnails?igsh=MW5zMnF0bmltY2xqNg==">
                                        {/* instagram svg */}
                                ...
                                <li
                                className="bg-secondarylight rounded-full w-fit max-h-fit p-3">
                                    <a target="_blank" rel="noreferrer" href="https://wa.link/o6odrt">
                                        {/* whatsapp svg */}
